...
class core_model extends CI_Model{
    ...
    public function get_all($tabela = NULL, $condicao = NULL) {
        ...
        // FAZ A PRIMEIRA VERIFICAÇÃO SE A DABELA FOI PASSADA
        if($tabela){
             // SE CUMPRIR A PRIMEIRA VERIFICAÇÃO VAI VERIFICAR SE A VARIAVEL CONDIÇÃO É UM ARRAY ELA PASSA CASO NÃO RETORNA FALSO
          ...
          //caso não for passada nenhuma tabela vai retornar FALSO
          return FALSE;
        }
    }
    ...
    /*FUNÇÃO INSERIR DADOS NA BASE DE DADOS*/
